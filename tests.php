...
try {
    Decimal::normalize('123456789012345678901.00');
    throw new RuntimeException('Magnitude limit was not enforced');
} catch (InvalidArgumentException) {
}
try {
    Decimal::add('99999999999999999999.99999999', '0.00000001');
    throw new RuntimeException('Arithmetic overflow was not rejected');
} catch (InvalidArgumentException) {
}
try {
    Decimal::divide('1', '0');
    throw new RuntimeException('Division by zero was not rejected');
} catch (InvalidArgumentException) {
}
try {
    Api::arithmetic(['amounts' => ['1', '2', '3']], 'multiply');
    throw new RuntimeException('Extra arithmetic operands were not rejected');
} catch (InvalidArgumentException) {
}
if (count(Api::currencies()) !== 31) {
    throw new RuntimeException('Currency catalog count changed unexpectedly');
}
