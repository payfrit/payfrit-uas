# Universal Amount Standard API 0.0.1
...
`docs/universal-amount-type-0.0.1.md`.
...
allocation. The `/v1/amounts/add` endpoint is included in 0.0.1 primarily as a
...
Conversion is explicit-rate only in 0.0.1. The API does not claim that a rate
